...
export class UsersController {
  ...
  @ApiBearerAuth()
  @Get('all/admin/list')
  public getAllAdminList(): Promise<CommonResponseModel> {
    return this.userService.getAlladminList();
  }
  ...
  public getAllTeacherList(): Promise<CommonResponseModel> {
    return this.userService.getAllteacherList();
  }
  ...
  @ApiBearerAuth()
  @Get('all/parent/list')
  public getAllParentList(): Promise<CommonResponseModel> {
    return this.userService.getAllparentList();
  }
  ...
  public getAllStudentList(): Promise<CommonResponseModel> {
    return this.userService.getAllstudentList();
  }
